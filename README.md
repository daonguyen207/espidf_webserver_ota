...
Thư viện ota qua webserver cho espidf.
Phiên bản cho arduino ở đây https://github.com/daonguyen207/IOT47_wifi_ota
...
static httpd_handle_t start_webserver(void)
{
    ...
    config.uri_match_fn = httpd_uri_match_wildcard; //nhan duong path ghep
